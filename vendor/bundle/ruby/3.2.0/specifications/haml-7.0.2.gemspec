...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://haml.info/docs/yardoc/file.CHANGELOG.html", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/haml/haml" } if s.respond_to? :metadata=
